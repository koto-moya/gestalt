...
reporting_db_pool = pool.SimpleConnectionPool(minconn=1, maxconn=10,  dbname=os.getenv("DBNAME"), user=os.getenv("PGUSERREPORTING"), password=os.getenv("PGPASSWORDREPORTING"), host=os.getenv("PGHOST"), port=os.getenv("PGPORT"))
